// CS311: BST header file - DO NOT CHANGE THIS FILE!!
// This BST has an Up link to make it easy to go up to the parent in the tree later on
//------------------------------------------------------------
...
struct Vertex
{
	...
	int Balace;  // for EC (Extra Credit)
};   
